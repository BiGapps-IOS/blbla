...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        [self.delegate horizontalTableView:self didSelectIndexPath:indexPath];
    }
}
...
{
    UITableViewCell * cell = [self.delegate horizontalTableView:self cellIndexPath:indexPath];
