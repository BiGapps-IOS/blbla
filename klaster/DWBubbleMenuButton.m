...
- (void)showButtons {
    ...
    _kav = [[UIView alloc]init];
    _kav.backgroundColor = [UIColor redColor];
    [self addSubview:_kav];
        ...
        switch (self.direction) {
            ...
            case DirectionUp:
                ...
                finalPosition = CGPointMake(self.frame.size.width/2.f,
                                            ...
                                            - ((button.frame.size.height + self.buttonSpacing) * index)+25);
//                originKavPosition = CGPointMake(19, self.frame.size.height/2.f);
//                finalKavPosition = CGPointMake(19,self.frame.size.height/2.f);
                break;
        ...
        _kav.hidden = NO;
        //
        _kav.frame = CGRectMake(self.frame.size.width/2,self.frame.size.height-43, 5, self.frame.size.height-44);
        [UIView animateWithDuration:_animationDuration + _animationDuration/2 animations:^{
            
            _kav.frame = CGRectMake(self.frame.size.width/2,25, 1.5f, self.frame.size.height-44);
            _kav.alpha = 1.0;
...
//
//        CABasicAnimation *kavpositionAnimation = [CABasicAnimation animationWithKeyPath:@"position"];
//        
//        kavpositionAnimation.duration = 2.9f;
//        kavpositionAnimation.timingFunction = [CAMediaTimingFunction functionWithName:kCAMediaTimingFunctionEaseInEaseOut];
//        kavpositionAnimation.fromValue = [NSValue valueWithCGPoint:originKavPosition];
//        kavpositionAnimation.toValue = [NSValue valueWithCGPoint:finalKavPosition];
////        kavpositionAnimation.beginTime = CACurrentMediaTime() + (_animationDuration/(float)_buttonContainer.count * (float)i);
//        kavpositionAnimation.fillMode = kCAFillModeForwards;
//        kavpositionAnimation.removedOnCompletion = NO;
//        
//        [_kav.layer addAnimation:kavpositionAnimation forKey:@"positionAnimation"];
//        
//        _kav.layer.position = finalKavPosition;
...
- (void)dismissButtons {
    ...
    [UIView animateWithDuration:_animationDuration + _animationDuration/2 animations:^{
        ...
        //             _kav.frame = CGRectMake(19,53, 5, 290);
        _kav.frame = CGRectMake(self.frame.size.width/2,self.frame.size.height-43, 1.5f, 0);
        //_kav.alpha = 0.0;
...
- (void)_prepareForButtonExpansion {
    ...
    switch (self.direction) {
        case DirectionUp:
        {
            ...
            [self bringSubviewToFront:_homeButtonView];
        }
            break;
